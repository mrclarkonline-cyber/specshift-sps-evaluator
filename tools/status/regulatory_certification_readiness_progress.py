...
REG = Path("memory_layer/wiki/operator_memory/regulatory_certification_readiness/regulatory_certification_procurement_readiness_workplan.json")
ACTIVE = Path("memory_layer/wiki/operator_memory/active_workplan.json")

print("Regulatory, Certification, and Procurement Readiness status")
print("=" * 78)
print()
...
print()
print(f"Overall Regulatory Readiness progress score: {progress:.1f}%")
print()
print("Boundary: Regulatory readiness is preparation only.")
print("No certification, compliance, government approval, procurement approval, legal sufficiency, financial/tax approval, production monitoring, or truth validation claimed.")
