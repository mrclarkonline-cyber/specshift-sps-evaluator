...
REG = Path("memory_layer/wiki/operator_memory/specshift_claim_logic/specshift_claim_logic_negation_aware_safety_scanner_workplan.json")
ACTIVE = Path("memory_layer/wiki/operator_memory/active_workplan.json")

print("SpecShift Claim Logic + Negation-Aware Safety Scanner status")
print("=" * 82)
print()
...
print()
print(f"Overall Claim Logic progress score: {progress:.1f}%")
print()
print("Boundary: Claim logic layer is an internal safety-scanner scaffold only.")
