...
PIPELINES = [
    ("01", "WHO Disease Outbreak News", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ("02", "ReliefWeb / OCHA", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ...
    ("06", "EU Open Data Portal", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_final_source_access_repair_records.jsonl", "source-access-checked"),
    ...
    ("13", "Copernicus EMS / Data Space", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_final_source_access_repair_records.jsonl", "source-access-checked"),
    ...
    ("17", "JAXA", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ...
    ("21", "FAO GIEWS", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ("22", "IAEA IEC", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_last5_source_access_repair_records.jsonl", "source-access-checked"),
    ...
    ("25", "AHA Centre", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ...
    ("29", "ECLAC", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ...
    ("51", "SCAR / COMNAP", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_batch43_54_source_access_checked_records.jsonl", "source-access-checked"),
    ("52", "Arctic Council / AMAP", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ("53", "National Gazettes", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_remaining_source_access_fast_checked_records.jsonl", "source-access-checked"),
    ("54", "National Statistical Offices", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_batch43_54_source_access_checked_records.jsonl", "source-access-checked"),
    ("55", "Multi-Country Contradiction Detector", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_derived_pipeline_validation_records.jsonl", "source-access-checked"),
    ("56", "Global anomaly flagger", "memory_layer/wiki/operator_memory/worldwide_validated/phase2_derived_pipeline_validation_records.jsonl", "source-access-checked"),
]
